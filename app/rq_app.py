...
# 三个队列，默认超时30分钟
queue_image = Queue("image", connection=redis_conn, default_timeout=2400)
queue_video = Queue("video", connection=redis_conn, default_timeout=2400)
queue_other = Queue("other", connection=redis_conn, default_timeout=2400)
